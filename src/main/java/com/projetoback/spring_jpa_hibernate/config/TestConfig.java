package com.projetoback.spring_jpa_hibernate.config;
...
import com.projetoback.spring_jpa_hibernate.entities.enums.OrderStatus;
...
public class TestConfig implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		useRepository.saveAll(Arrays.asList(u1, u2)); //estou passando a lista de obj e salvando no banco 
		
		Order o1 = new Order(null, Instant.parse("2019-06-20T19:53:07Z"), OrderStatus.AGUARDADO_PAGAMENTO, u1);
